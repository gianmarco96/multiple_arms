...
********* THIS ACTUALLY WORKS *****************
ros2 run pymoveit2 ex_pose_goal.py --ros-args -r __ns:=/arm1 -p position:="[0.5, 0.01, 0.20]"
"""


# I need to be able to control this from separate nodes now and then convert it to Artur's library
...
def main():
    ...
    node.declare_parameter("position", [0.5, 0.0, 0.30])
